...
_TOOLS: frozenset[str] = frozenset(
    {
        "airflow", "android", "ansible", "api design", "aws", "azure", "bash",
        "bigquery",
        "c", "c#", "c++", "ci/cd", "celery", "clickhouse", "cloud run", "dbt",
        "dart", "django", "docker", "dynamodb", "elasticsearch", "etl",
        "fastapi",
        "flask", "flutter", "gcp", "git", "github", "gitlab", "go",
        "grafana", "graphql",
        "grpc", "ios", "java", "javascript", "jenkins", "kafka", "kotlin",
        "kubernetes", "linux", "microservices", "mongodb", "mysql", "nginx",
        "node.js", "numpy", "objective-c", "observability", "pandas",
        "postgresql",
        "prometheus", "pyspark", "pytest", "python", "pytorch", "rabbitmq",
        "react", "react native", "redis", "rest", "ruby", "rust", "scala",
        "selenium",
        "snowflake", "spark", "sql", "sqlalchemy", "swift", "system design",
        "tensorflow", "terraform", "threading", "typescript", "unit testing",
        "vue", "webhooks",
    }
)
...
_CONCEPTS: frozenset[str] = frozenset(
    {
        "algorithms", "automated testing", "automation", "caching",
        "code review", "concurrency", "containers", "data modeling",
        "data pipelines", "data structures", "databases", "debugging",
        "disaster recovery", "distributed systems", "fault tolerance",
        "high availability", "incident response", "infrastructure",
        "integration testing", "load balancing", "logging", "app lifecycle",
        "machine learning", "message queues", "mobile development",
        "model evaluation",
        "model training", "monitoring", "networking", "operating systems",
        "performance tuning", "reliability", "scalability", "scripting",
        "site reliability", "software architecture", "test automation",
        "throughput", "traffic routing", "version control", "web scraping",
    }
)
...
_REQUIRED_CUES = (
    "required", "requirement", "must have", "must be", "minimum",
    "you have", "we require", "essential", "qualifications",
)
_PREFERRED_CUES = (
    "preferred", "nice to have", "nice-to-have", "bonus", "a plus",
    "plus if", "desirable", "ideally", "helpful",
)
...
_REQUIRED_HEADERS = (
    "requirement", "qualification", "must have", "what you", "you have",
    "minimum", "basic qualification", "responsibilities", "essential",
)
_PREFERRED_HEADERS = (
    "nice to have", "nice-to-have", "preferred", "bonus", "plus",
    "desirable", "good to have", "optional",
)
